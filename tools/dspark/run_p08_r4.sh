...
# Run in the same initialized CANN/custom-op container as P08-R3.
set -u
set -o pipefail
...
P08_BASELINE=25a1ceba0f3b222f881eeddb058c85d88b980e23
...
p08_main() {
    ...
    P08_OUT=$(mktemp -d /workspace/dspark-results/m2_5a-p08-r4.XXXXXX) || return 1
    ...
    VLLM_PORT=29864 MASTER_PORT=29864 python "$P08_PLUGIN_REPO/tools/dspark/benchmark_dspark_acceptance.py" \
