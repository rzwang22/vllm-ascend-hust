...
def test_execute_draft_runs_backbone_markov_and_core_publication() -> None:
    ...
    assert "_build_core_proposal" in calls
...
def test_production_wires_markov_and_proposal_publication() -> None:
