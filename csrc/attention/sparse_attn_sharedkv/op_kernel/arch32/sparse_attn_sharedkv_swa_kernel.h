...
__aicore__ inline void SparseAttnSharedkvSwa<SAST>::UpdateInnerLoopCond()
{
    ...
    bool oriIsEmpty = constInfo.hasOriSparseIndices ? !hasOriWindow : tempLoopInfo.actOriS2Size == 0;
    if ((tempLoopInfo.actCmpS2Size == 0 && oriIsEmpty) || (tempLoopInfo.actS1Size == 0)) {
    ...
    for (uint32_t bN2LoopIdx = constInfo.bN2Start; bN2LoopIdx < constInfo.bN2End; bN2LoopIdx++) {
        ...
        for (uint32_t gS1LoopIdx = constInfo.gS1Start; gS1LoopIdx < gS1LoopEnd; gS1LoopIdx++) {
            ...
            if (tempLoopInfo.curActSeqLenIsZero) {
                ...
                if (constInfo.hasOriSparseIndices && tempLoopInfo.oriMaskRight < tempLoopInfo.oriMaskLeft) {
                    oriS2Size = 0;
                }
